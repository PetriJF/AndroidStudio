...
public class Autonomie extends LinearOpMode {
            ...
            for (int i = 0; i < numImages; i++) {
                ...
                /*int stride = img.getStride();
                  ...
                  imageWidth - 1, imageHeight  - 1 left down*/
                        ...
                        telemetry.addData("sfera 2" , Sphere2.size);
                        telemetry.addData("cub " , Cube.size);

                        if (Cube.size != 0 && Sphere1.size > 0 && Sphere2.size > 0) return "CENTER";
                        if (Cube.size != 0 && Sphere1.size > 0) return "LEFT";
                        if (Cube.size != 0) return "RIGHT";
                    }
                }
            }
    ...
    public void MoveMineral()
    {
        if (nav == "Front")
        {
            ...
            {
                rotateRobotLeft(0.15f);
                while (modernRoboticsI2cGyro.getHeading() < 355 && modernRoboticsI2cGyro.getHeading() > 180)
                    sleep(10);
                setMotorSpeed(0f);
            }
            ...
            {
                rotateRobotLeft(0.15f);
                while (modernRoboticsI2cGyro.getHeading() < 340 && modernRoboticsI2cGyro.getHeading() > 180)
                    sleep(10);
                setMotorSpeed(0f);
            }
